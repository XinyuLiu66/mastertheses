...
import pickle
from Supervised_method_KP_Extraction.read_train_test_data import reader
path = "./SemEval2010"
train_docs, test_docs, label_file = reader(path)
#
rank_svm = pickle.load(open("test_rank_svm.p", "rb"))
test_text = train_docs["C-41.txt.final"]
